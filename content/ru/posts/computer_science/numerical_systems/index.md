...
Переведем число \(257_8\) из восьмеричной системы счисления в двоичную.

 1. Разобьем число на отдельные цифры: \(2\), \(5\), \(7\)
 2. Преобразуем каждую цифру в двоичную: 
	$$ 2_{8} = 010_2 $$ 
	$$ 5_{8} = 101_2 $$ 
	$$ 7_{8} = 111_2 $$
...
##### Самостоятельное задание
Переведите в двоичную систему числа: \(10_8\), \(787_8\), \(242_8\), \(100_8\), \(78_8\), \(777_8\)
...
Переведем число \(FF1_{16}\) в двоичную систему счисления.
...
2. Пользователь указывает основание для исходной и целевой систем счисления.
