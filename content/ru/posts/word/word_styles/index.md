...
title = 'Редактор текстовых документов. Стили, шаблоны'
...
Стили, колонтитулы, шаблоны Буфер обмена, поиск, замена. Колонтитулы, сноски. Приёмы и средства автоматизации обработки документов и управление объектами.*
