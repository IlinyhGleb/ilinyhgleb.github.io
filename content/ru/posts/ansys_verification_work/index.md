...
## Задание 3
![plita](plita.svg)
- **геометрия**: однопролётная плита перекрытия (Ш×Д×В) *6м*×*4м*×*0.2м* с отверстиями диаметром *0.15м*, расстояние между отверстиями *0.03м* 
- **материал**: бетон
- **граничные условия**: неподвижные шарниры по краям плиты
...
- **нагрузка**: распределённая нагрузка по верхней полке двутавра *10кН/м*
- **задание**: получить напряженно-деформированное состояние конструкции, 
