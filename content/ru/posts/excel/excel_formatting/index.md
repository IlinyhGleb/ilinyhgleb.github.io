...
На листе **Лист1** выделите диапазон ячеек **A1:P9** (поместите курсор мыши на ячейку **A1**, зажмите *левую клавишу мыши (ЛКМ),* переместите курсор на ячейку **P9**, отпустите *ЛКМ*):
