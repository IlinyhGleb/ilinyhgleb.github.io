...
Так как в Python всё является объектами, лямбда-функции - тоже объекты. Следовательно функции можно создавать в [цикле]({{< ref "python_loop_algorithm.md" >}}), и ссылки  на них помещать в структуры данных.
